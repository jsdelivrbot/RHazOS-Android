...
public final class Opcodes
{
    ...
    public static boolean isValidShape(final int opcode) {
        if (opcode < -1) {
            return false;
        }
        if (opcode == -1) {
        ...
        final int lowByte = opcode & 0xFF;
        return lowByte == 0 || lowByte == 255 || (opcode & 0xFF00) == 0x0;
    }
    
    public static int extractOpcodeFromUnit(final int opcodeUnit) {
        final int lowByte = opcodeUnit & 0xFF;
